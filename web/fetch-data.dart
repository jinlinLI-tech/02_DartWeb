...
void _polulateFromJson() {
  ...
  final chocolateReadioButton =
      jsonData['cholate'] == false ? noLoveForChocolate : loveChocolate;
  chocolateReadioButton.checked = true;
}

//Dispaly all values as JSON
